            ...
            <div class="breadcrumbs panel z-1 py-2 bg-gray-25 dark:bg-gray-100 dark:bg-opacity-5 dark:text-white">
                <div class="container max-w-xl">
                    <ul class="breadcrumb nav-x justify-center gap-1 fs-7 sm:fs-6 m-0">
                        ...
                        <li><i class="unicon-chevron-right opacity-50"></i></li>
                        <li><a href="/category">Strategy</a></li>
                        <li><i class="unicon-chevron-right opacity-50"></i></li>
                            ...
                            <div class="post-content panel fs-6 md:fs-5" data-uc-lightbox="animation: scale">
                                ...
                                <div class="panel mt-3">
                                    <figure class="float-end ms-3 mb-1">
                                        <figure class="featured-image m-0 ratio ratio-1x1 sm:w-300px rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="/assets/images/common/img-fallback.png" data-src="/assets/images/main/posts/post-1.jpg" alt="Holding flower, by Anthony Tran" data-uc-img="loading: lazy">
                                            <a href="/assets/images/main/posts/post-1.jpg" class="position-cover" data-caption="Holding flower, by Anthony Tran"></a>
                                        </figure>
                                ...
                                <figure class="my-3 sm:my-4">
                                    <figure class="featured-image m-0 ratio ratio-3x2 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="/assets/images/common/img-fallback.png" data-src="/assets/images/main/posts/post-2.jpg" alt="Pink Marketing, by Mak" data-uc-img="loading: lazy">
                                        <a href="/assets/images/main/posts/post-2.jpg" class="position-cover" data-caption="Pink Marketing, by Mak"></a>
                                    </figure>
                                ...
                                <div class="panel my-3">
                                    <figure class="float-start me-3 mb-0">
                                        <figure class="featured-image m-0 ratio ratio-1x1 sm:w-300px rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="/assets/images/common/img-fallback.png" data-src="/assets/images/main/posts/post-3.jpg" alt="Great Schools and Entertainment" data-uc-img="loading: lazy">
                                            <a href="/assets/images/main/posts/post-3.jpg" class="position-cover" data-caption="Great Schools and Entertainment"></a>
                                        </figure>
                                ...
                                <div class="row g-4 items-center">
                                    <div class="col-12 sm:col-5 xl:col-3">
                                        <figure class="featured-image m-0 ratio ratio-1x1 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="/assets/images/common/img-fallback.png" data-src="/assets/images/main/posts/post-author.jpg" alt="Amir Nisi" data-uc-img="loading: lazy">
                                        </figure>
                                    </div>
                                    <div class="col">
